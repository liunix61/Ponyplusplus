...
TEST(CodegenCov14, FloatLiteral) {
    EXPECT_TRUE(emit_ok(
        "actor main {\n"
        "  new create() => {\n"
        "    let x: F64 = 3.14\n"
...
/* ==================== String size (lines 308-311) ==================== */

TEST(CodegenCov14, StringSize) {
    EXPECT_TRUE(emit_ok(
        "actor main {\n"
        "  new create() => {\n"
        "    let s: String = \"hello\"\n"
...
TEST(CodegenCov14, SelfFieldAccess) {
    EXPECT_TRUE(emit_ok(
        "actor main {\n"
        "  var _id: U32\n"
        "  new create() => {\n"
...
TEST(CodegenCov14, ArrayLiteral) {
    EXPECT_TRUE(emit_ok(
        "actor main {\n"
        "  new create() => {\n"
...
TEST(CodegenCov14, ComplexProgram) {
    EXPECT_TRUE(emit_ok(
        "actor Worker {\n"
        "  var _id: U32\n"
        "  new create() => {\n"
